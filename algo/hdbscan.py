...
class HDBSCAN:
    ...
    def run_and_analyze(run_times: int,
                        ...
                        n_jobs: int = -1):
        """
        Run the HDBSCAN algorithm with some hyper-parameters
        ...
        print('HDBSCAN clustering algorithm instantiated')
        ...
        cluster_algo_file_path = os.path.join(save_dir, 'HDBSCAN.eps')
        ...
        Logger.print("\nFinished HDBSCAN clustering run")
        return results
