...
class BISECTINGKMEANS:
    ...
    def run_and_analyze(run_times: int,
                        ...
                        n_jobs: int = -1):
        """
        Run the BisectingKMeans algorithm with some hyper-parameters
        ...
        algo = BisectingKMeans(n_clusters=n_clusters, random_state=73)
        ...
        plt.title("BisectingKMeans", size=18)
        ...
        cluster_algo_file_path = os.path.join(save_dir, 'BisectingKMeans.eps')
        ...
        Logger.print("\nFinished BisectingKMeans clutering run")
        return results
