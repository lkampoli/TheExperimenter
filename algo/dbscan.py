...
class _DBSCAN_:
    ...
    def run_and_analyze(run_times: int,
                        ...
                        n_jobs: int = -1):
        """
        Run the DBSCAN algorithm with some hyper-parameters
        ...
        algo = DBSCAN()
        print('DBSCAN clustering algorithm instantiated')
        ...
        cluster_algo_file_path = os.path.join(save_dir, 'DBSCAN.eps')
        ...
        Logger.print("\nFinished DBSCAN clustering run")
        return results
