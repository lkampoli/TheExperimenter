...
class _OPTICS_:
    ...
    def run_and_analyze(run_times: int,
                        ...
                        n_jobs: int = -1):
        """
        Run the OPTICS algorithm with some hyper-parameters
        ...
        algo = OPTICS(min_samples=20, xi=0.1, min_cluster_size=0.2)
        print('OPTICS clustering algorithm instantiated')
        ...
        cluster_algo_file_path = os.path.join(save_dir, 'OPTICS.eps')
        ...
        Logger.print("\nFinished OPTICS clustering run")
        return results
