...
class BIRCH:
    ...
    def run_and_analyze(run_times: int,
        ...
        algo = Birch(n_clusters=n_clusters, threshold=0.01, branching_factor=10)
        ...
        cluster_algo_file_path = os.path.join(save_dir, 'Birch.eps')
