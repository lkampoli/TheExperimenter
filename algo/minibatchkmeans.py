...
class MINIBATCHKMEANS:
    ...
    def run_and_analyze(run_times: int,
        ...
        algo = MiniBatchKMeans(n_clusters=n_clusters, n_init="auto", random_state=73)
        ...
        cluster_algo_file_path = os.path.join(save_dir, 'MiniBatchKMeans.eps')
        ...
        Logger.print("\nFinished MiniBatchKMeans clustering run")
        #Logger.print(results["labels"])
        #Logger.print(results["centroids"])
        return results
