...
class SPECTRALCLUSTERING:
    ...
    def run_and_analyze(run_times: int,
                        ...
                        n_jobs: int = -1):
        """
        Run the SpectralClustering algorithm with some hyper-parameters
        ...
        algo = SpectralClustering(n_clusters=n_clusters, eigen_solver="arpack", affinity="nearest_neighbors", random_state=73)
        ...
        cluster_algo_file_path = os.path.join(save_dir, 'SpectralClustering.eps')
        ...
        Logger.print("\nFinished SpectralClustering clustering run")
        return results
