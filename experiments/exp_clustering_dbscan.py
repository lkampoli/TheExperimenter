...
from algo.dbscan import _DBSCAN_


class ExpDBSCAN(Experiments):
    """
    ...
    def perform(clustering_bool: bool,
        ...
        Experiments.run(clustering_bool=clustering_bool,
                        ...
                        algo_str=algo_str,
                        results_folder=os.path.join(os.path.dirname(os.path.dirname(__file__)), DBSCAN_RESULTS_FOLDER_NAME),
                        data_path=os.path.join(os.path.dirname(os.path.dirname(__file__)), DBSCAN_DATA_FOLDER_NAME),
                        #data_generation_function=DBSCANDataGenerator.generate_kmeans,
                        clustering_algo=_DBSCAN_,
                        numerical_run_times=DBSCAN_NUMERICAL_RUN_TIMES,
