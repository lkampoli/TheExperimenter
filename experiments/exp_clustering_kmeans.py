...
from algo.kmeans import KMEANS


class ExpKmeans(Experiments):
    """
    ...
    def perform(clustering_bool: bool,
        ...
        Experiments.run(clustering_bool=clustering_bool,
                        ...
                        algo_str=algo_str,
                        results_folder=os.path.join(os.path.dirname(os.path.dirname(__file__)), KMEANS_RESULTS_FOLDER_NAME),
                        data_path=os.path.join(os.path.dirname(os.path.dirname(__file__)), KMEANS_DATA_FOLDER_NAME),
                        #data_generation_function=KMEANSDataGenerator.generate_kmeans,
                        clustering_algo=KMEANS,
                        numerical_run_times=KMEANS_NUMERICAL_RUN_TIMES,
